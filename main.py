...
def main():
    ...
    L = get_input("请输入你的学习能力（L）: ", 1.0, 1.1, "学习能力反映了你每年增长的知识比例。范围：1.0 - 1.1, 一般学习能力极强的为1.1,意味着你能在1-2个月内学习任何一门知识并成为仅次于专家的人，建议一般人写1.03-1.06")
    S = get_input("请输入你的项目成功率（S）: ", 0.5, 1.0, "项目成功率反映了你的项目成功的概率。范围：0.5 - 1.0。正常项目成功率是0.6-0.75")
    E = get_input("请输入你的外部环境因子（E）: ", 0.7, 1.5, "外部环境因子反映了外部环境对你的资产增长的影响。范围：0.7 - 1.5，行业年增长率10%为1.1，年增长率20%为1.2，依此类推")
